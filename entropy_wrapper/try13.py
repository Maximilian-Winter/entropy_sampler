...
def generate_html_report(generation_results: Dict, wrapper: BaseEntropyAnalysisWrapper, folder_name: str, output_html_file: str):
    ...
    # The generated_ids include both the input and generated tokens
    # The step_analyses correspond only to the generated tokens
    # So we need to align the tokens with the step analyses
    num_generated_tokens = len(step_analyses)
    tokens = tokens[-num_generated_tokens:]  # Get only the generated tokens
